...
class Course {
  ...
  final String room;
  final String category; // <-- Ditambahkan untuk Tantangan 1
  ...
  const Course({
    ...
    required this.category, // <-- Ditambahkan ke constructor
  });
  ...
  static List<Course> getSampleCourses() {
    return const [
      Course(
        ...
        progress: 0.25,
        room: 'Lab Komputer 3',
        category: 'Praktikum', // <-- Ditambahkan
      ),
      Course(
        code: 'TRPL502',
